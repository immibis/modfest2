 ...
 * 1.0.2: Changed mod ID and package name to captchalogue_sylladex (instead of compuglobalhypermeganet).
 *   That means if you were using the modfest version and you update, all your moduses will get deleted.
 */
public class CaptchalogueMod implements ModInitializer {
	
	public static final int MODUS_SLOT = 8;
	public static final Identifier MODUS_SLOT_BG_IMAGE = new Identifier("captchalogue_sylladex", "placeholder_fetch_modus");
	public static final Identifier MEMORY_MODUS_QUESTION_MARK_IMAGE = new Identifier("captchalogue_sylladex", "memory_game_unrevealed_slot");
	public static final Identifier MEMORY_MODUS_CROSS_IMAGE = new Identifier("captchalogue_sylladex", "memory_game_empty_slot");
	
	
	public static final ItemGroup itemGroupCaptchalogue = FabricItemGroupBuilder.build(
			new Identifier("captchalogue_sylladex", "captchalogue"),
	...
	private static class ItemWithCreativeDupeWarning extends Item {
		...
		public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
			...
			if(mc != null && mc.player != null && mc.player.container instanceof CreativeContainer) {
				tooltip.add(new TranslatableText("item.captchalogue_sylladex.hashtable_fetch_modus.creative_mode_warning.1"));
				tooltip.add(new TranslatableText("item.captchalogue_sylladex.hashtable_fetch_modus.creative_mode_warning.2"));
			}
		}
	}
	...
	public void onInitialize() {
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "queue_fetch_modus"), itemQueueFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "stack_fetch_modus"), itemStackFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "array_fetch_modus"), itemArrayFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "queuestack_fetch_modus"), itemQueuestackFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "hashtable_fetch_modus"), itemHashtableFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "memory_fetch_modus"), itemMemoryFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "tree_leaf_fetch_modus"), itemTreeLeafFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "tree_root_fetch_modus"), itemTreeRootFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "queue_array_fetch_modus"), itemQueueArrayFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "stack_array_fetch_modus"), itemStackArrayFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "queuestack_array_fetch_modus"), itemQueuestackArrayFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "array_hashtable_fetch_modus"), itemArrayHashtableFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "queue_hashtable_fetch_modus"), itemQueueHashtableFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "stack_hashtable_fetch_modus"), itemStackHashtableFetchModus);
		Registry.register(Registry.ITEM, new Identifier("captchalogue_sylladex", "queuestack_hashtable_fetch_modus"), itemQueuestackHashtableFetchModus);
